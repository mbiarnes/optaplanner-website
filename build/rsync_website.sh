...
#############################################################################################################################################################################
#
#   You can't ex ecute this script locally since keys, stored in Jenkins, are needed
...
rsync --dry-run -Pavqr --protocol=28 --delete-after target/website/* optaplanner@filemgmt.jboss.org:www_htdocs/optaplanner
